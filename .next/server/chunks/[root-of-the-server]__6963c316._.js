        ...
        if (update.message && update.message.text) {
            ...
            if (message.reply_to_message) {
                ...
                if (gramjsMonitor) {
                    ...
                    console.log('❌ Monitor GramJS não está disponível no webhook');
                }
                console.log('❌ Aposta não encontrada nos caches');
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6963c316._.js.map