...
"[project]/node_modules/rx-lite/rx.lite.js [app-route] (ecmascript)": ((__turbopack_context__) => {
...
(function(undefined) {
    ...
    var freeExports = objectTypes["TURBOPACK compile-time value", "object"] && exports && !exports.nodeType && exports, freeSelf = objectTypes[typeof self] && self.Object && self, freeWindow = objectTypes["undefined"] && window && window.Object && window, freeModule = objectTypes["TURBOPACK compile-time value", "object"] && module && !module.nodeType && module, moduleExports = freeModule && freeModule.exports === freeExports && freeExports, freeGlobal = freeExports && freeModule && ("TURBOPACK compile-time value", "object") == 'object' && ("TURBOPACK ident replacement", globalThis) && ("TURBOPACK ident replacement", globalThis).Object && ("TURBOPACK ident replacement", globalThis);
    ...
    /** `Object#toString` result shortcuts */ var argsClass = '[object Arguments]', arrayClass = '[object Array]', boolClass = '[object Boolean]', dateClass = '[object Date]', errorClass = '[object Error]', funcClass = '[object Function]', numberClass = '[object Number]', objectClass = '[object Object]', regexpClass = '[object RegExp]', stringClass = '[object String]';
   ...
   */ var RefCountDisposable = Rx.RefCountDisposable = function() {
    ...
    (function(schedulerProto) {
        ...
        function scheduleInnerRecursive(action, self1) {
            action(function(dt) {
                self1(action, dt);
            });
        }
    ...
    /** Gets a scheduler that schedules work immediately on the current thread. */ var immediateScheduler = Scheduler.immediate = function() {
   ...
   */ var Notification = Rx.Notification = function() {
     ...
     */ Notification.prototype.toObservable = function(scheduler) {
            ...
            return new AnonymousObservable(function(observer) {
                return scheduler.scheduleWithState(self1, function(_, notification) {
    ...
    */ Observable.isObservable = function(o) {
    ...
    var ScheduledObserver = Rx.internals.ScheduledObserver = function(__super__) {
        ...
        ScheduledObserver.prototype.next = function(value) {
            ...
            this.queue.push(function() {
                self1.observer.onNext(value);
            });
        };
        ScheduledObserver.prototype.error = function(e) {
            var self1 = this;
            this.queue.push(function() {
                self1.observer.onError(e);
            });
        };
        ScheduledObserver.prototype.completed = function() {
            var self1 = this;
            this.queue.push(function() {
                self1.observer.onCompleted();
            });
        };
        ScheduledObserver.prototype.ensureActive = function() {
            ...
            if (isOwner) {
                this.disposable.setDisposable(this.scheduler.scheduleRecursiveWithState(this, function(parent, self1) {
                    var work;
    ...
    var ConcatEnumerableObservable = function(__super__) {
        ...
        ConcatEnumerableObservable.prototype.subscribeCore = function(o) {
            ...
            var cancelable = immediateScheduler.scheduleRecursiveWithState(this.sources[$iterator$](), function(e, self1) {
                if (isDisposed) {
                    return;
                }
                ...
                d.setDisposable(currentValue.subscribe(new InnerObserver(o, self1, e)));
            });
    ...
    var CatchErrorObservable = function(__super__) {
        ...
        CatchErrorObservable.prototype.subscribeCore = function(o) {
            ...
            var isDisposed, subscription = new SerialDisposable();
            var cancelable = immediateScheduler.scheduleRecursiveWithState(null, function(lastException, self1) {
                if (isDisposed) {
                    return;
                }
                var currentItem = tryCatch(e.next).call(e);
    ...
    Enumerable.prototype.catchErrorWhen = function(notificationHandler) {
        ...
        return new AnonymousObservable(function(o) {
            ...
            var cancelable = immediateScheduler.scheduleRecursive(function(self1) {
                if (isDisposed) {
                    return;
                }
                var currentItem = tryCatch(e.next).call(e);
                ...
                outer.setDisposable(currentValue.subscribe(function(x) {
                    ...
                    inner.setDisposable(notifier.subscribe(self1, function(ex) {
                        o.onError(ex);
                    }, function() {
                        o.onCompleted();
                    }));
   ...
   */ observableProto.concat = function() {
    ...
    var ConcatObservable = function(__super__) {
        ...
        ConcatSink.prototype.run = function() {
            ...
            var cancelable = immediateScheduler.scheduleRecursiveWithState(0, function(i, self1) {
                if (isDisposed) {
                    return;
                }
                if (i === length) {
   ...
   */ observableProto.shareReplay = function(bufferSize, windowSize, scheduler) {
    ...
    function observableTimerDateAndPeriod(dueTime, period, scheduler) {
        return new AnonymousObservable(function(observer) {
            ...
            return scheduler.scheduleRecursiveWithAbsoluteAndState(0, d, function(count, self1) {
                if (p > 0) {
            ...
            subscription = source.materialize().timestamp(scheduler).subscribe(function(notification) {
                ...
                if (shouldRun) {
                    if (exception !== null) {
                        ...
                        d.setDisposable(scheduler.scheduleRecursiveWithRelative(dueTime, function(self1) {
    ...
    function debounce(source, dueTime, scheduler) {
        ...
        return new AnonymousObservable(function(observer) {
            ...
            var subscription = source.subscribe(function(x) {
                ...
                value = x;
                id++;
                var currentId1 = id, d = new SingleAssignmentDisposable();
                cancelable.setDisposable(d);
                d.setDisposable(scheduler.scheduleWithRelative(dueTime, function() {
                    hasvalue && id === currentId1 && observer.onNext(value);
                    hasvalue = false;
                }));
            }, function(e) {
                cancelable.dispose();
...
//# sourceMappingURL=node_modules_rx-lite_rx_lite_4f4ae8b0.js.map